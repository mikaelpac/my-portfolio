...
function Navigation({ colorTheme, setTheme }) {
  ...
  return (
    <div
      className="sticky p-4 px-6 md:px-20 top-0 z-10 backdrop-blur-sm"
      style={{ background: `rgba(0, 0, 0, ${backgroundTransparency})` }}
    >
      <nav className="flex items-center max-w-7xl m-auto justify-between text-white dark:text-white">
        ...
        <ul className="flex items-center space-x-4">
          <li>
            <a href="#about">
              <button className="md:hover:text-yellow-500 ml-5 mr-3 select-none">
                About
              </button>
            </a>
          </li>
